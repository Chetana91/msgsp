...
public class FrequentSequence {
	...
	public void addIntermediateSequence(DataSequence seq)
	{  //this function is used to append a sequence to the existing result sequence when forming candidates
		sequence.add(seq);
	}
	public void addFrequentSequence(FrequentSequence fs)
	{  //this sequence adds all the sequences of a frequent sequence,formed in previous step
